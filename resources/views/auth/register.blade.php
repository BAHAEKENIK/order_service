...
<head>
    ...
    <title>Create an Account - Easy Services</title>
    ...
    <style>
        /* Shared Auth Page Styles (can be reused from login.blade.php if you centralize CSS) */
        :root {
        ...
        .form-title { font-size: 2rem; font-weight: 600; margin-bottom: 2rem; text-align: center; color: var(--text-dark); }
        ...
        .checkbox-label { display: flex; align-items: center; font-size: 0.875rem; color: var(--text-dark); }
        body.dark-mode .checkbox-label { color: var(--text-light); }
        .checkbox-label input[type="checkbox"] { margin-right: 0.5rem; accent-color: var(--primary-color); }
    ...
    <div class="auth-container">
        <div class="auth-form-section">
            ...
            <div class="form-wrapper">
                ...
                {{-- Specific error for session expiration --}}
                ...
                @endif
                <form method="POST" action="{{ route('register.storeUser') }}"> {{-- <<< MODIFIED HERE --}}
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <input id="email" class="form-input" type="email" name="email" value="{{ old('email') }}" required autocomplete="username" placeholder="example.email@gmail.com">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="form-input-container">
                            <input id="password" class="form-input pr-10" type="password" name="password" required autocomplete="new-password" placeholder="Enter at least 8+ characters">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="form-input-container">
                            <input id="password_confirmation" class="form-input pr-10" type="password" name="password_confirmation" required autocomplete="new-password" placeholder="Confirm password">
                    ...
                    <!-- Become a Provider Checkbox -->
                    <div class="mb-6">
                        <label for="is_provider" class="checkbox-label">
                            <input id="is_provider" type="checkbox" name="is_provider" value="1" {{ old('is_provider') ? 'checked' : '' }}>
                    ...
                    <div>
                     ...
                     <p class="text-sm text-center text-muted-light dark:text-muted-dark mt-6">
                        Already have an account? <a href="{{ route('login') }}" class="link font-medium">Sign in</a>
                    </p>
                </form>
            </div>
        </div>
         <div class="auth-illustration-section">
            <img src="{{ asset('images/login.png') }}" alt="Registration Illustration"> {{-- Use the same or a different image --}}
        </div>
    </div>
...
<script>
    ...
    const applyTheme = (theme) => { /* ... same as login.blade.php ... */
        if (theme === 'dark') {
    ...
    function togglePasswordVisibility(fieldId, iconId) { /* ... same as reset-password.blade.php ... */
